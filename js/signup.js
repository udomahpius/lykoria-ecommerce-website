...
async function   signup(){
  try {
    ...
    if (!res.ok) {
      document.getElementById("msg").innerText = data.error || "Signup failed.";
      document.getElementById("msg").style.color = "red";
    } else {
      document.getElementById("msg").innerText = data.message || "Signup successful!";
    ...
    document.getElementById("msg").innerText = "Failed to connect: " + err.message;
    document.getElementById("msg").style.color = "red";
    console.error(err);
  }
}
